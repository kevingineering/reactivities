...
{
  //goes to facebook to verify token, get information we need, deserializing information, and returning to handler
  public class FacebookAccessor : IFacebookAccessor
  {
    ...
    {
      //verity token is valid - response is either 200 or not
